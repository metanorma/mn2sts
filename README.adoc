...
[source,sh]
----
java -jar target/mn2sts-1.0.jar --xml-file tests/iso-tc154-8601-1-en.xml --xml-file-out tests/iso-tc154-8601-1-en.out.xml
----
...
<version>1.0</version>
<name>Metanorma MN XML to ISO STS converter</name>
----
