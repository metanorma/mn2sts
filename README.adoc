...
[source,sh]
----
java -jar target/mn2sts-1.6.jar --xml-file-in <XML-FileName> --xml-file-out <Output-XML-FileName>
----
...
[source,sh]
----
java -jar target/mn2sts-1.6.jar --xml-file-in tests/iso-tc154-8601-1-en.xml --xml-file-out tests/iso-tc154-8601-1-en.out.xml
----
